...
public class MailService {
    ...
    private static final String USER = "oumaima.ouali@esprit.tn";     // Must be valid user in d.umn.edu domain, e.g. "smit0012"
    private static final String PASSWORD = "99838369oumaima"; // Must be valid password for smit0012
    private static final String FROM = "oumaima.ouali6";     // Full info for user, e.g. "Fred Smith <smit0012@d.umn.edu>"
}